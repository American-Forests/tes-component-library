...
var reactAccordion = require('@szhsin/react-accordion');
...
var AccordionItem = function AccordionItem(_ref) {
  ...
  return React.createElement(reactAccordion.AccordionItem, Object.assign({}, rest, {
    header: function header(_ref2) {
      ...
      }, isEnter ? React.createElement(reactIcons.MinusIcon, null) : React.createElement(reactIcons.PlusIcon, null)), (variant === 'secondary' || nested) && React.createElement("div", {
        className: "text-brand-green w-4 h-4 transition-transform duration-200 ease-in-out " + (isEnter && "rotate-180")
      }, React.createElement(reactIcons.ChevronDownIcon, null)));
    },
...
var Accordion = function Accordion(_ref3) {
  ...
  return React.createElement(reactAccordion.Accordion, {
    transition: true,
...
//# sourceMappingURL=tes-component-library.cjs.development.js.map
